...
import type { ScoredPlace, HighlightsResult } from "@truebite/shared";
  ...
  return (
    <li className="rise">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
        className={`flex w-full items-start gap-4 border-t py-5 text-left transition-colors hover:bg-surface/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sage sm:gap-6 ${
